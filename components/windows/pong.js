...
import styles from "../../styles/pong.module.scss";
  ...
  function init() {
    ...
    var Game = {
      initialize: function () {
        ...
        this.canvas.width = frame.width * 2;
        ...
        if (!this.over) {
          ...
          if (this.paddle.y > this.ball.y - this.paddle.height / 2) {
            if (this.ball.moveX === DIRECTION.RIGHT)
              this.paddle.y -= this.paddle.speed / 1.9;
  ...
  return (
    <div className={styles.content}>
      <div className={styles.bezel}>
        <canvas id="pong" className={styles.pong}></canvas>
      </div>
    </div>
  );
};
